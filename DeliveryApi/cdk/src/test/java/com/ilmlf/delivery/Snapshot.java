...
/**
 * Contains a static method to make Jackson compatible with json-snapshot.
 * This is used by `SnapshotMatcher.start()` in the snapshot test class.
 *
 * See https://github.com/json-snapshot/json-snapshot.github.io/issues/27 for details
 */
