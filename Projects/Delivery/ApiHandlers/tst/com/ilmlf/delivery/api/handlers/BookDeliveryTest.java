...
import com.ilmlf.delivery.api.handlers.BookDelivery;
import com.ilmlf.delivery.api.handlers.Delivery;
import com.ilmlf.delivery.api.handlers.HandlerErrorMessage;
...
It injects mocked lotService to the object and 
 * checks that the handler return correct response for both happy and failure scenarios
 */
public class BookDeliveryTest {
  ...
  /**
   * Initialize GSON to deserialize response body.
   */
  @BeforeAll
