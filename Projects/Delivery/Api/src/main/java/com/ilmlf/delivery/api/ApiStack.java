...
public class ApiStack extends Stack {
  ...
  public static class ApiStackProps implements StackProps {
    ...
    private String dbVpcId;
    private String dbSgId;
  ...
  public ApiStack(final Construct scope, final String id, final ApiStackProps props)
    ...
    this.dbVpc =
        Vpc.fromLookup(
            this,
            "DB-VPC",
            VpcLookupOptions.builder().isDefault(false).vpcId(props.getDbVpcId()).build());

    this.dbSg = SecurityGroup.fromSecurityGroupId(this, "DB-SG", props.getDbSgId());
  ...
  private Role createLambdaRdsProxyRoleWithIam(ApiStackProps props) {
    ...
    String rdsProxyId = props.dbProxyArn.substring(props.dbProxyArn.indexOf("prx-"));
